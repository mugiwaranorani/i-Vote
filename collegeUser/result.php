                ...
                <div id="partylista" class="carousel slide" data-bs-ride="carousel">
                  <div class="carousel-inner rounded imgCon">
                    <?php
                      ...
                      $positions = array('PRESIDENT', 'VICE PRESIDENT', 'SECRETARY', 'TREASURER', 'AUDITOR', 'COLLEGE REP');
                    ...
                    <div class="carousel-item active">
                      <img src="picture/<?php echo $row['picture']?>" class="imgResult d-block w-100" alt="candidate photo">
          ...
          <div class="container">
            ...
            <table class="table table-responsive table-hover table-dark rounded" style="overflow: hidden;">
              ...
              <tbody>
                ...
                ?>
                <tr>
                  <th scope="row"><img src="picture/<?php echo $row['picture']?>" alt="sc candidate" class="tableImg"></th>
