...
<div class="full-main">
  ...
  <br>
        ...
        <!--FILTER END-->
      <div class="container"><h2>VOTE RECEIPT</h2></div>
      <div class="container overflow-auto rounded" style="height: 550px;" >

        <div class="vote-container p-3 rounded" style="border: 3px solid;">

          <div class="container-fluid text-success" style="margin-left:-8px;"><h4>NOTICE: Your vote has been processed successfully! </h4><br></div>
